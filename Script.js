...
checkboxInicioZero.addEventListener('change', atualizarGrafico);
checkboxCurvaSuave.addEventListener('change', atualizarGrafico);
checkboxEmpilhado.addEventListener('change', atualizarGrafico);
checkboxPreencherArea.addEventListener('change', atualizarGrafico);
selecaoTipoGrafico.addEventListener('change', atualizarGrafico);
...
function atualizarGrafico() {
    ...
    const tipoGrafico = selecaoTipoGrafico.value;
